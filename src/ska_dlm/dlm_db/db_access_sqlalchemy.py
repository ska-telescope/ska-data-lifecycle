...
class DBQueryError(DataLifecycleError):
    ...
    def __init__(self, query: str, params: Optional[Dict[str, Any]] = None, error: Optional[Exception] = None):
        ...
        self.params = params
        self.error = error
        self.message = str(error) if error else "Unknown database error"
    ...
    def __str__(self):
        ...
        return f"DBQueryError: {self.message}"
...
class SQLAlchemyAccess(contextlib.AbstractContextManager):
    ...
    def insert(self, table: str, *, json: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DBQueryError(query=f"INSERT INTO {table}", params=json, error=e) from e
    ...
    def update(
        ...
        try:
            ...
            raise DBQueryError(query=f"UPDATE {table}", params={"json": json, "params": params}, error=e) from e
    ...
    def select(self, table: str, *, params: Optional[Dict[str, Any]] = None) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise DBQueryError(query=f"SELECT FROM {table}", params=params, error=e) from e
    ...
    def delete(self, table: str, *, params: Optional[Dict[str, Any]] = None) -> None:
        ...
        try:
            ...
            raise DBQueryError(query=f"DELETE FROM {table}", params=params, error=e) from e
...
def create_db_access():
    ...
    #ska_dlm_admin:password@dlm_db:5432/ska_dlm
    ...
    database = os.environ.get("PGDATABASE", "ska_dlm")
